    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/" className="flex items-center">
          ...
          <p className="text-white font-bold text-2xl m-4">Tomoro</p>
        </Link>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 px-4  lg:px-6">
          ...
          <div className="lg:mb-4">
            <Link
              href="/request/create"
              className="inline-flex items-center justify-center rounded-md bg-primary px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10 w-full"
            >
              Create Request
            </Link>
          </div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/bidding"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("bidding") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <FaGavel />
                  My Bidding
